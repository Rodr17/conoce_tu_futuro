...
<?=$this->section('titulo')?>Agregar Tipos de combustibles<?=$this->endSection()?>

<?=$this->section('contenido')?>

<!-- Título -->
<h1 class="text-2xl md:text-3xl text-slate-800 font-bold mb-8">Agregar Tipos de combustibles</h1>
...
<div class="bg-white shadow-lg rounded-sm mb-8">
	<div class="flex flex-col md:flex-row md:-mr-px">
		...
		<div class="grow">
			...
			<!-- Formulario -->
			<form class="px-6 space-y-6" action="<?= base_url(route_to('crear_tipos_de_combustible')) ?>" method="POST">
				<?= csrf_field() ?>
				
				<h2 class="text-2xl text-slate-800 font-bold mb-5">Agregar Tipo</h2>
				...
				<footer>
					<div class="flex flex-col px-6 py-5 border-t border-slate-200">
						<div class="flex self-end">
                            ...
                            <?php if($usuario_actual->can('tipos_de_combustible.crear')) : ?>
