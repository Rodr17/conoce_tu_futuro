...
<?=$this->section('titulo')?>Agregar color<?=$this->endSection()?>

<?=$this->section('contenido')?>

<!-- Título -->
<h1 class="text-2xl md:text-3xl text-slate-800 font-bold mb-8">Agregar color</h1>
...
<div class="bg-white shadow-lg rounded-sm mb-8">
	<div class="flex flex-col md:flex-row md:-mr-px">
		...
		<div class="grow">
			...
			<!-- Formulario -->
			<form class="px-6 space-y-6" action="<?= base_url(route_to('crear_colores')) ?>" method="POST">
				<?= csrf_field() ?>
				
				<h2 class="text-2xl text-slate-800 font-bold mb-5">Agregar color</h2>
				...
				<section>
					...
					<div class="grid gap-5 md:grid-cols-3 mt-5">
						<div class="">
							...
							<input id="hexadecimal" type="color" name="hexadecimal" value="<?= old('hexadecimal') ?>" style="padding: .2rem">
				...
				<footer>
					<div class="flex flex-col px-6 py-5 border-t border-slate-200">
						<div class="flex self-end">
                            ...
                            <?php if($usuario_actual->can('colores.crear')) : ?>
