...
class Auth extends ShieldAuth
{
     ...
     */
    public array $views = [
        'login'                       => '\App\Views\Authn\inicio_sesion',
		'register'                    => '\App\Views\Authn\registro',
		'layout'                      => '\App\Views\Authn\plantilla',
		'action_email_2fa'            => '\CodeIgniter\Shield\Views\email_2fa_show',
		'action_email_2fa_verify'     => '\CodeIgniter\Shield\Views\email_2fa_verify',
		'action_email_2fa_email'      => '\CodeIgniter\Shield\Views\Email\email_2fa_email',
		'action_email_activate_show'  => '\App\Views\Authn\email_activate_show',
		'action_email_activate_email' => '\CodeIgniter\Shield\Views\Email\email_activate_email',
		'magic-link-login'            => '\App\Views\Authn\recuperar_cuenta',
		'magic-link-message'          => '\App\Views\Authn\magic_link_message',
    ...
    public array $tables = [
        'users'             => 'usuarios',
		'identities'        => 'authn_identidades',
		'logins'            => 'authn_intentos_inicio_sesion',
		'token_logins'      => 'authn_token_inicio_sesiones',
		'remember_tokens'   => 'authn_tokens_recuerdame',
		'groups_users'      => 'authn_grupos_usuarios',
		'permissions_users' => 'authn_permisos_usuarios',
    ];
     ...
     */
    public string $userProvider = Usuarios::class;
